...
parser.add_argument('--starting_epoch', type=int, default=0,
                    help='help to resume. If previous generating does not generate the expected amount of data, when resuming, set this term to the previous epoch number to prevent from overlapping')
parser.add_argument('--ins_cnt_fn', type=str,
                    help='a file listing all category instance count, which is used to balance the interaction data amount to make sure that all categories have roughly same amount of data interaction, regardless of different shape counts in these categories')
