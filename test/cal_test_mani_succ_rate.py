...
def calculate_succ_ration(data_list_for_cat, conf, out_dir):
    ...
    for cat in conf.category_types:
        if cat in data_list_for_cat.keys():
            ...
            continue
    train_cat = ['Safe', 'Door', 'Display', 'Refrigerator', 'Laptop', 'Lighter', 'Microwave', 'Mouse', 'Box',
                 'TrashCan', 'KitchenPot', 'Suitcase', 'Pliers', 'StorageFurniture', 'Remote', 'Bottle'
        , 'FoldingChair', 'Toaster', 'Lamp', 'Dispenser', 'Eyeglasses', 'Pen', 'Printer', 'Keyboard', 'Fan', 'Knife',
                 'Dishwaher']
    ...
    print(
        f'test seen acc on {count_train} samples is {osum_train / count_train}, test unseen acc on {count_test} samples is {osum_test / count_test}')
...
if __name__ == '__main__':
    ...
    conf.category_types = ['Safe', 'Door', 'Display', 'Refrigerator', 'Laptop', 'Lighter', 'Microwave', 'Mouse', 'Box',
                           'TrashCan', 'KitchenPot', 'Suitcase', 'Pliers', 'StorageFurniture', 'Remote', 'Bottle'
        , 'FoldingChair', 'Toaster', 'Lamp', 'Dispenser', 'Toilet', 'Scissors', 'Table', 'Printer', 'Kettle', 'USB',
                           'WashingMachine', 'Oven', 'Faucet', 'Phone']
