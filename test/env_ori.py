...
class Env(object):
    ...
    def __init__(self, flog=None, show_gui=True, render_rate=20, timestep=1/500, \
        ...
        # Remove original lighting setup code
        # add lights
        ...
        # Main directional light - replacing the old set_shadow_light
        ...
        # Add auxiliary point light sources
        scene.add_point_light([1 + self.object_position_offset, 2, 2], [1, 1, 1])
        scene.add_point_light([1 + self.object_position_offset, -2, 2], [1, 1, 1])
        scene.add_point_light([-1 + self.object_position_offset, 0, 1], [1, 1, 1])
